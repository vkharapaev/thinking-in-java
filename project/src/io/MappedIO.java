...
public class MappedIO {
    private static final int NUM_OF_INTS = 100_000_000;
    ...
    private static Tester[] tests = {
            ...
            new Tester("Stream Write") {
                public void test() throws IOException {
                    DataOutputStream dos = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(new File("temp.tmp"), true)));
            ...
            new Tester("Stream Read/Write") {
                public void test() throws IOException {
                    ...
                    raf.writeInt(1);
                    for (int i = 1; i < NUM_OF_UBUFF_INTS; i++) {
                        raf.seek(i - 1);
